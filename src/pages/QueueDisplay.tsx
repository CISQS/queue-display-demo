            ...
            <div className="flex flex-col gap-2">
              <div className={isLabDraftV2 ? "flex w-full items-start gap-[2px]" : "flex w-full items-start gap-2"}>
                <div
                  className={[
                    isLabDraftV2
                      ? "flex h-[388px] min-w-0 flex-1 flex-col overflow-hidden rounded-l-[10px] rounded-r-none bg-[#fcf8f4] text-black shadow-[0_16px_30px_rgba(134,101,63,0.05)] ring-1 ring-[#c8ac88]/10"
                      : "flex h-[388px] w-[39%] min-w-0 shrink-0 flex-col overflow-hidden rounded-2xl bg-[#fcf8f4] text-black shadow-[0_16px_30px_rgba(134,101,63,0.05)]",
                  ].join(" ")}
                >
                ...
                {isLabDraftV2 ? (
                  <div className="flex min-w-0 flex-[2] gap-[2px]">
                    <div className="flex h-[388px] min-w-0 flex-1 flex-col overflow-hidden rounded-none bg-[#f8fbf5] text-black shadow-[0_16px_30px_rgba(111,140,114,0.05)] ring-1 ring-[#9caf93]/10">
