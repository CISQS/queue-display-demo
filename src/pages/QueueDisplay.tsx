            ...
            >
              ...
              {station === "dr" ? (
                ...
                <div
                  className={
                    station === "lab"
                      ? "ml-3 cursor-pointer text-[18px] font-bold leading-tight"
        ...
        {station === "dr" ? (
          ...
          <div className="w-full flex-1 px-4 py-5">
            <div className="flex flex-col gap-2">
              <div className={isLabDraftV2 ? "flex w-full items-start gap-[2px]" : "flex w-full items-start gap-2"}>
                <div
                  className={[
                    isLabDraftV2
                      ? "flex h-[328px] min-w-0 flex-1 flex-col overflow-hidden rounded-l-[10px] rounded-r-none bg-[#fcf8f4] text-black shadow-[0_16px_30px_rgba(134,101,63,0.05)] ring-1 ring-[#c8ac88]/10"
                      : "flex h-[328px] w-[39%] min-w-0 shrink-0 flex-col overflow-hidden rounded-2xl bg-[#fcf8f4] text-black shadow-[0_16px_30px_rgba(134,101,63,0.05)]",
                  ].join(" ")}
                >
                ...
                {isLabDraftV2 ? (
                  <div className="flex min-w-0 flex-[2] gap-[2px]">
                    <div className="flex h-[328px] min-w-0 flex-1 flex-col overflow-hidden rounded-none bg-[#f8fbf5] text-black shadow-[0_16px_30px_rgba(111,140,114,0.05)] ring-1 ring-[#9caf93]/10">
                    ...
                    <div className="flex h-[388px] min-w-0 flex-1 flex-col overflow-hidden rounded-l-none rounded-r-[10px] bg-[#fcf8f4] text-black shadow-[0_16px_30px_rgba(134,101,63,0.05)] ring-1 ring-[#c8ac88]/10">
                      ...
                      <div className="min-h-0 flex-1 overflow-hidden bg-[#f8fbf5] px-5 py-4">
                        {(() => {
                          ...
                          return (
                            <div className="flex h-full max-h-[312px] flex-col gap-y-3 text-[25px] font-bold tabular-nums text-[#2f2b23]">
                              {missedTickets.map((ticket) => (
                                <div key={`lab-missed-v2-${ticket}`} className="min-h-[34px] leading-none whitespace-nowrap text-[#2f2b23]">
                                  {ticket}
                                </div>
                              ))}
                            </div>
                  ...
                  <div className="flex h-[328px] min-w-0 flex-1 flex-col overflow-hidden rounded-2xl bg-[#f8fbf5] text-black shadow-[0_16px_30px_rgba(111,140,114,0.05)] ring-1 ring-[#9caf93]/10">
                    <div className="flex h-11 items-center justify-center bg-[#00B18B] text-xl font-semibold tracking-wide text-white">
                      等待中 Queuing
                    </div>
                    <div className="min-h-0 flex-1 overflow-hidden bg-[#f8fbf5] px-5 py-4">
                ...
                <div className="flex h-[150px] w-full min-w-0 flex-col overflow-hidden rounded-2xl bg-[#fcf8f4] text-black shadow-[0_16px_30px_rgba(134,101,63,0.05)] ring-1 ring-[#c8ac88]/10">
                  ...
                  <div className="min-h-0 flex-1 overflow-hidden bg-[#f8fbf5] px-5 py-4">
                    {(() => {
                      const missedTickets = (labDisplay?.missed ?? []).slice(0, 4);
                      return (
                        <div className="flex h-full max-h-[104px] flex-wrap content-start gap-x-12 gap-y-3 text-[25px] font-bold tabular-nums text-[#2f2b23]">
                          {missedTickets.map((ticket) => (
